# Task-02 Linux File Permissions
...
# login to app server 2 and switch to sudo user
 sudo su -

# verify is /tmp/xfusioncorp.sh is existing in the path ornot
 ls -l /tmp/xfusioncorp.sh

# add chmod(chnagemode) to +x (executable file)
 chmod +x /tmp/xfusioncorp.sh

# verify , is /tmp/xfusioncorp.sh executable file or not
 ls -l /tmp/xfusioncorp.sh
